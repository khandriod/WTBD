...
# Train YOLOv8 with Efficient Multi-Scale Attention for Wind Turbine Damage Detection
...
echo "🚀 Training YOLOv8 with Efficient Multi-Scale Attention for Wind Turbine Damage Detection"
echo "🎯 Best for: Real-time inspection systems, drone-based deployment"
echo "📁 Results will be saved in: $(pwd)/wind_turbine_attention/ema"
echo "=========================================="

# Set variables
MODEL_CONFIG="./ultralytics/cfg/models/v8/yolov8_EMA.yaml"
