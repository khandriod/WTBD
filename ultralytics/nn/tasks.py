...
from ultralytics.nn.modules import (AIFI, C1, C2, C3, C3TR, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, C3Ghost, C3x,
                                    ...
                                    CoordinateAttention, CBAMv2, SelectiveKernelAttention, EfficientMultiScaleAttention,
                                    MultiScalePyramidAttention, EdgeEnhancedAttention)
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        elif m is SelectiveKernelAttention:
            c1 = ch[f]
            args = [c1, *args]
            
        elif m is EfficientMultiScaleAttention:
            c1 = ch[f]
            args = [c1, *args]
            
        elif m is MultiScalePyramidAttention:
            c1 = ch[f]
            args = [c1, *args]
            
        elif m is EdgeEnhancedAttention:
            c1 = ch[f]
            args = [c1, *args]
