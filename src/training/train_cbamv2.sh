...
# Train YOLOv8 with CBAM v2 for Wind Turbine Damage Detection
# This script trains the model using YOLO CLI format and saves results in current directory.
# Perfect for surface damage patterns and texture anomalies.

echo "🚀 Training YOLOv8 with CBAM v2 for Wind Turbine Damage Detection"
echo "🎯 Best for: Surface damage patterns, texture anomalies, lightning strike damage"
echo "📁 Results will be saved in: $(pwd)/wind_turbine_attention/cbamv2"
echo "=========================================="

# Set variables
MODEL_CONFIG="./ultralytics/cfg/models/v8/yolov8_CBAMv2.yaml"
DATA_CONFIG="./GRAZPEDWRI-DX/data/data.yaml"
PROJECT_DIR="$(pwd)/wind_turbine_attention"
EXPERIMENT_NAME="cbamv2"
